...
import { InboundPayment as Entity } from "../../entities/main/InboundPayment";
import { InboundPaymentRepository as EntityRepository } from "../../repositories/main/InboundPaymentRepository";

export class InboundPaymentController {
    private static entityName: string = "inbound payment";
    private static entityJSONName: string = "inboundPayment";
